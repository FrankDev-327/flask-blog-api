...
def upgrade():
    ...
    if column_name not in columns:
        op.add_column(table_name, sa.Column(column_name, sa.DateTime, default=sa.func.now()))
...
def downgrade():
    ...
    if column_name not in columns:
        op.drop_column(table_name, sa.Column(column_name, sa.DateTime, default=sa.func.now()))
