...
from controllers.interesting.listing_user_same_interest_controller import ListingUserSameInterestController
...
def register_interesting_route(api: Api):
    ...
    api.add_resource(ListingUserSameInterestController, '/interesting/same-interest', methods=['GET'], endpoint='listing_user_same_interest')
