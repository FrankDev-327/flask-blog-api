...
class ContactService:
    ...
    def add_contact(self, user_id, contact_id):
        ...
        try:
            ...
            self.redis_service.publish("friend_request_notification", notify_user_request)
            return {
                ...
                'contact': {
                    ...
                    'created_at': self.helper.formatting_time(new_contact.created_at, "%Y-%m-%d %H:%M:%S")
                }
            }, 201
    ...
    def __check_contact_exists(self, user_id, contact_id):
        try:
            stmt = select(ContactsModel).where(
                ...
                ContactsModel.contact_id == contact_id
            )
            ...
            contacts_list = [
                {
                    ...
                    'created_at': self.helper.formatting_time(contact.created_at, "%Y-%m-%d %H:%M:%S")
                }
